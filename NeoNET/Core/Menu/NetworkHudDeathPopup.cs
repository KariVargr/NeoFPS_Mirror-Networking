...
namespace NeoFPS.Mirror.Menu
{
	...
	public class NetworkHudDeathPopup : PlayerCharacterHudBase
    {
        ...
        [SerializeField] private UnityEvent m_OnDeathMenu = new UnityEvent();
		...
		{    
            ...
            if(!alive)
                StartCoroutine(DeathMenuDisplay());
		}

        private IEnumerator DeathMenuDisplay()
        {
