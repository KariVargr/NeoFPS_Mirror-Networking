...
{
    public class NeoFPSNetworkManager : NetworkManager
    {
        ...
        /// <summary>
        /// Dispatched when the client stops it's connection to the server.
        /// </summary>
        public static event Action RelayOnStopClient;
        #endregion

        /// <summary>
        /// All spawned local players.
        /// </summary>
        ...
        {       
            Application.targetFrameRate = base.serverTickRate;
        }
